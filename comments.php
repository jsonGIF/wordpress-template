...
<strong><?php comment_author_link() ?></strong>, <?php _e(''); ?> <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> <?php _e('kl');?> <?php comment_time() ?></a> <?php _e('Skrev&#58;'); ?> <?php edit_comment_link('Edit Comment','',''); ?>
...
<p class="nocomments">Kommentarer är stängt.</p>
...
<p>Du måste vara <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php the_permalink(); ?>">inloggad</a> för att lämna en kommentar.</p>
...
<label for="email"><small>Email (kommer ej visas) <?php if ($req) echo "*"; ?></small></label></p>
